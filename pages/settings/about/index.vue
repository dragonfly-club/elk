  ...
  <MainContent back-on-small-screen>
    ...
    <template v-if="isHydrated">
      <SettingsItem
        ...
        :to="showCommit ? `https://github.com/dragonfly-club/elk/commit/${buildInfo.commit}` : undefined"
    ...
    <SettingsItem
      ...
      to="/mast.dragon-fly.club/@notremonde"
      large target="_blank"
    />
    <SettingsItem
      text="GitHub"
      icon="i-ri:github-fill"
      to="https://github.com/dragonfly-club/elk"
