  ...
  <footer p4 text-sm text-secondary-light flex="~ col">
    ...
    <div>
      ...
      <NuxtLink
        ...
        external
        :href="`https://github.com/dragonfly-club/elk/releases/tag/v${buildInfo.version}`"
        target="_blank"
        font-mono
      >
        v{{ buildInfo.version }}
      ...
      <template v-if="buildInfo.commit && buildInfo.branch !== 'release'">
        ...
        <NuxtLink
          external
          :href="`https://github.com/dragonfly-club/elk/commit/${buildInfo.commit}`"
          target="_blank"
          font-mono
        >
    ...
    <div>
      ...
      &middot;
      <NuxtLink href="/mast.dragon-fly.club/@notremonde" target="_blank">
        Mastodon
      </NuxtLink>
      &middot;
      <NuxtLink href="https://github.com/dragonfly-club/elk" target="_blank" external>
        GitHub
      </NuxtLink>
    </div>
  </footer>
